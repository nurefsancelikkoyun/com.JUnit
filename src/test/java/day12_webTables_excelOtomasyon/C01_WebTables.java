...
public class C01_WebTables extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        Thread.sleep(2000);
        WebElement tumbodyEelementi =driver.findElement(By.tagName("tbody"));
        System.out.println(tumbodyEelementi.getText());

        /*
        Tum body'i tek element olarak locate etmek
        body içinde geçen bir metnin varlığını test etmek gibi görevler için kulanılabilir
         */
